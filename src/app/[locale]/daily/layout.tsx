...
const COPY = {
  he: { title: "הסרט של היום", description: "סרט אחד ביום, דירוג מהיר, והשוואה לציון של כל השאר. חוזרים מחר והרצף ממשיך." },
  en: { title: "Today's film", description: "One film a day, picked for what the day feels like." },
};
